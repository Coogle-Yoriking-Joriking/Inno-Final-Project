package com.inno.coogle.global.error;

import com.inno.coogle.global.error.exception.BusinessException;
...
public class GlobalExceptionHandler { //전역 예외 핸들링용 클래스 생성
